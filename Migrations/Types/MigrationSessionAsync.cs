...
{
    public class MigrationSessionAsync
    {
        public MigrationSessionAsync() { }

        internal MigrationSessionAsync(
        ...
        internal readonly IEnumerable<MigrationAsync> MigrationsToBeApplied;
    }
}
